...
public class Main {
    ...
    static void listTask(List<Task> taskList){
        if(taskList.size()>0){
            for(Task i: taskList){
/*
                Collections.sort(Task.getPriority());
*/
                System.out.println((i)+".\t Title: "+i.getTitle());
                System.out.println((i)+".\t Description: "+i.getDescription());
                System.out.println((i)+".\t Priority: "+i.getPriority());
            }
        }else
        { System.out.println("the task list is empty\n");
        }
